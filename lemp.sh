...
# Software versions
# Magento 1
MAGE_TMP_FILE="https://www.dropbox.com/s/pr157zr52lqu5qt/magento-1.9.3.7-2017-11-27-05-32-35.tar.gz"
...
REPO_MASCM_TMP="https://raw.githubusercontent.com/testnet1/MagentoFiles2/master/"
# HHVM package
...
REPO_FAN="https://www.dropbox.com/s/lp85xzmtdqnc0p4/city-fan.org-release-2-1.rhel7.noarch.rpm"
# WebStack Packages
        ...
        if [ "$?" = 0 ] # if package installed then configure
          then
            echo
              ...
              wget -qO /etc/my.cnf https://raw.githubusercontent.com/testnet1/MagentoFiles2/master/my.cnf
              echo
                echo
